...
python hello.py Alice --hologram
python hello.py Alice --cinema
python hello.py Alice --bracket
python hello.py Alice --badge
python hello.py Alice --dossier
